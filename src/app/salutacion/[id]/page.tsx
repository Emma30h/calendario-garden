...
function drawGreetingCard(
  ...
  ctx.fillText(orgLabel, centerX, orgLabelY);
  ...
  const messageLines = wrapCanvasText(ctx, messageText || DEFAULT_MESSAGE, pageWidth - 200);
              ...
              <div className="space-y-4 rounded-xl border border-white/15 bg-white/10 p-3 backdrop-blur-sm lg:flex lg:min-h-0 lg:flex-col lg:space-y-3 lg:overflow-y-auto lg:p-3 lg:pr-2">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-white/20 bg-slate-900/55 px-3 py-2 text-xs font-semibold text-slate-100 outline-none ring-sky-300/35 transition focus:ring-2"
                  >
